...
const cctvSchema = new Schema({
  ...
  // Type of camera for mobile app tracking logic (e.g. gateIn starts a trip, gateOut ends it).
  camera_type: { type: String, enum: ['gateIn', 'gateOut', 'internal'], default: 'internal' },
