...
| `changes/2026-07-29-mobile-add-vehicle-type-field.md` | done | T1-T20 change record for mobile add vehicle type field standardisation in MongoDB (`vehicle_info.type`). |
